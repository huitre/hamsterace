...
PersonModel.prototype = Object.create(events.EventEmitter.prototype);
  
PersonModel.prototype.populateFriends = function (rows) {
  var friends = [],
...
PersonModel.prototype.authFindOrCreate = function (profile, done) {
  var where = {},
 ...
 * @return Promise
 */
PersonModel.prototype.getAll = function (id, done) {
 ...
 * @return Promise
 */
PersonModel.prototype.getOne = function (id, done) {
 ...
 * @return Promise
 */
PersonModel.prototype.getFriends = function (UserId, isFriend, refused) {
  var self = this;
 ...
 * @return Promise
 */
PersonModel.prototype.getFriendsIdList = function (UserId) {
 ...
 * @return Promise
 */
PersonModel.prototype.findByName = function (name) {
...
PersonModel.prototype.request = {}

/*
 * @return Promise
 */
PersonModel.prototype.request.get = function (userId) {
  return this.getFriends(userId, false, false);
}

/*
 * @return Promise
 */
PersonModel.prototype.request.post = function (userId, friendId) {
 ...
 * @return Promise
 */
PersonModel.prototype.accept = function (userId, friendId) {
  var self = this;
...
PersonModel.prototype.remove = function (userId, friendId) {
  return new Promise(function (fulfill, reject) {
    Db.PeopleFriend.find({
      where : {
        FriendId : friendId,
...
PersonModel.prototype.refuse = function (userId, friendId) {
  return new Promise(function (fulfill, reject) {
    Db.PeopleFriend.find({
      where : {
        FriendId : friendId,
