...
FeedModel.prototype = Object.create(events.EventEmitter.prototype);
 ...
 * @params callback
 */
FeedModel.prototype.getFeed = function (User, done) {
  var publicy, UserId;
...
FeedModel.prototype.findOnePost = function (id, done) {
  Db.Post.find({
      where : {
        id: id
      },
...
FeedModel.prototype.findOneComment = function (id, done) {
  Db.Comment.find({
    where : {
      id : id
    },  
...
FeedModel.prototype.addPost = function (User, content, done) {
  var UserId, bo = this;
...
FeedModel.prototype.deletePost = function (User, postId, done) {
  var UserId, bo = this;
...
FeedModel.prototype.addComment = function (User, content, postId, done) {
